...
namespace TpixAPI.Migrations
{
    ...
    [Migration("20190307094424_added identity guid column for members")]
    partial class addedidentityguidcolumnformembers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TpixAPI.Models.Database.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TpixAPI.Models.Database.Member", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TpixAPI.Models.Database.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TpixAPI.Models.Database.Report", b =>
                {
            ...
            modelBuilder.Entity("TpixAPI.Models.Database.Topic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TpixAPI.Models.Database.VotePost", b =>
                {
                    b.Property<int>("FkPostId")
                        .HasColumnName("FK_PostId");
            ...
            modelBuilder.Entity("TpixAPI.Models.Database.VoteTopic", b =>
                {
                    b.Property<int>("FkTopicId")
                        .HasColumnName("FK_TopicId");
            ...
            modelBuilder.Entity("TpixAPI.Models.Database.Category", b =>
                {
                    b.HasOne("TpixAPI.Models.Database.Member", "FkCreatedByNavigation")
                        .WithMany("Category")
            ...
            modelBuilder.Entity("TpixAPI.Models.Database.Post", b =>
                {
                    ...
                    b.HasOne("TpixAPI.Models.Database.Topic", "FkParentTopic")
                        .WithMany("Post")
            ...
            modelBuilder.Entity("TpixAPI.Models.Database.Topic", b =>
                {
                    b.HasOne("TpixAPI.Models.Database.Category", "FkCategory")
                        .WithMany("Topic")
